...
class TypoNormalizer:
    ...
    # ✅ Phase 5.7.8: 규정 용어 사전 (미송 가이드 적용)
    STATUTE_TERMS = {
        # ✅ Phase 5.7.8 추가: 고빈도 띄어쓰기 오류 (미송 제안)
        ...
        # ✅ Phase 5.7.8 추가: 복합 띄어쓰기 (미송 제안)
        '직무의 종류': '직무의 종류',  # 정상 (사전 제외)
        '직무의종류': '직무의 종류',
        '그밖에': '그 밖에',
        '그 밖에': '그 밖에',  # 정상
    }
